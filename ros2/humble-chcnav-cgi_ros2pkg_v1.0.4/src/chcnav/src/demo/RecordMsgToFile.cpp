...
static void devimu_sentence_callback(const msg_interfaces::msg::Hcrawimub::ConstPtr msg)
{
    ...
    fprintf(gs_fp__devimu_time_record, "%lf,", msg->acceleration.x);
    fprintf(gs_fp__devimu_time_record, "%lf,", msg->acceleration.y);
    fprintf(gs_fp__devimu_time_record, "%lf,", msg->acceleration.z);
